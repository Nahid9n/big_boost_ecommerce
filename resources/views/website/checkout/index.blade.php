                        ...
                        <div class="bill_form">
                            <h2>Billing Details</h2>
                                ...
                                <div class="1st_input">
                                    ...
                                    <input id="fist" type="text" name="name" class="form-control" value="{{$customer->name}}" readonly>
                                </div>
                                <div class="7st_input">
                                    <div><label for="email">Email Address</label></div>
                                    <input id="email" type="email" name="email" class="form-control" value="{{$customer->email}}" readonly>
                                </div>
                                <div class="3st_input">
                                    <div><label for="stree">Delivery address</label></div>
                                    <input id="stree" type="text" name="delivery_address" class="form-control" placeholder="delivery address" required>
                                </div>
                                <div class="6st_input">
                                    <div><label for="num">Phone Number</label></div>
                                    <input id="num" type="number" class="form-control" name="phone" placeholder="phone Number" required>
                                </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 ">
                        <div class="billings">
                            ...
                            <div class="row mb-5">
                                <div class="unit1 col-lg-6 col-md-6 col-sm-6 col-sm-6 ">
                                    <div class="pro-imge d-flex"><img src="{{asset($product->options->image)}}" width="50" height="50" alt="image">
                                ...
                                <div class="unit2 col-lg-6 col-md-6 col-sm-6 col-sm-6 ">
                                    <div class="pro-rate"><p>৳ {{$product->price}}</p></div>
                                    <div class="pro-rate"><p>quantity : {{$product->qty}} piece</p></div>
                                </div>
                            </div>
                                @php($shipping_cost = $shipping_cost+ $product->options->shipping_cost)
                            ...
                            <div class="order-summary" style=" margin-top: 20px;">
                                ...
                                <div class="row">
                                    <div class="bill_pay col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="sshiping-tt mb-3">
                                            <input type="radio" class="radio form-group" >
                                            bank
                                        </div>
                                        <div class="input-group mb-5">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <input type="radio" class=" radio-btn mt-2" name="payment_method" value="cash on">
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="text-center border-0" >
                                            <button type="submit" data-toggle="modal" data-target="#cartModal">Place Order</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
