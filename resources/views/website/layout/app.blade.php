...
<!-- Add to cart bar -->
    @include('website.layout.add-to-cart')
<!-- Add to cart bar end-->


<!-- Add to wishlist bar -->
    @include('website.layout.add-to-wishlist')
<!-- Add to wishlist bar end-->


<!-- My account bar -->
    @include('website.layout.account-bar')
<!-- Add to wishlist bar end-->


<!-- Add to cart modal popup start-->
    @include('website.layout.add-to-cart-modal')
<!-- Add to cart modal popup end-->


<!-- Quick-view modal popup start-->
    @include('website.layout.quick-view-modal')
...
<!-- theme setting -->
    ...
    <div class="setting_box_body">
        ...
        <div class="setting-body">
            ...
            <div class="buy_btn">
                <a href="{{asset('/')}}website/index.html" target="_blank" class="btn btn-block purchase_btn"><i class="fa fa-desktop" aria-hidden="true"></i> View Showcase</a>
...
<!-- facebook chat section start -->
    ...
    <script>(function(d, s, id) {
        ...
        js.src = '{{asset('/')}}website/{{asset('/')}}website/{{asset('/')}}website/connect.facebook.net/en_US/sdk/xfbml.customerchat.js#xfbml=1&version=v2.12&autoLogAppEvents=1';
