...
@section('body')
    <!-- breadcrumb start -->
    <section class="breadcrumb-section my-3">
        <div class="container">
            <div class="row">
                <div class="col-12">
                                    ...
                                    <div class="collection-product-wrapper">
                                        ...
                                        <div class="product-wrapper-grid">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-3 my-2 col-md-4 col-6 col-grid-box">
                                                        ...
                                                        <div class="product-box">
                                                            <div class="img-block">
                                                                ...
                                                                <div class="cart-details">
                                                                    ...
                                                                    <a href="{{route('product.details',['id'=>$product->id])}}" data-bs-toggle="modal" data-bs-target="#quick-view{{$product->id}}"  title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>
                                                                    <a href="#"  title="Compare"><i class="ti-reload" aria-hidden="true"></i></a>
                                                                </div>
                                                            </div>
                                                            <div class="product-info">
                                                                <div>
                                                                    <a href="{{route('product.details',['id'=>$product->id])}}"><h5>{{$product->name}}</h5></a>
                                                                    <h6>{{$product->selling_price}}.Tk</h6>
                                                                    <a class="btn btn-primary my-1" href="{{route('product.details',['id'=>$product->id])}}" data-bs-toggle="modal" data-bs-target="#quick-view{{$product->id}}"  title="Quick View">Quick View</a>
                                                                </div>
                                                            </div>
