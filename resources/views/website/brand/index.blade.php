                    ...
                    <ul>
                        <li class="dropdown-holder hassubs list-inline-item mr-0"><a href="#"><i style="margin-right: 10px;" class="fa fa-bars" ></i>All Category</a>
                            <ul>
                                ...
                                @endforeach
                                <li class="all"><a  href="#">All category</a></li>
                            </ul>
                        </li>
            ...
            <div class="row">
                <div class="home_alls">
                    <ul>
                        ...
                        <li><a target="blank" href="product.html">All Categories</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="items itemss">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 colsm6 ">
                                <div class="card card-body">
                                    <div class="m-0">
                                        <a href="{{route('product.by.brand',['id'=>$brand->id])}}" target="blank">
                                            <img src="{{asset($brand->logo)}}" height="150" class="w-100" alt="a" />
                                        </a>
                                    </div>
                                    <div class="info">
