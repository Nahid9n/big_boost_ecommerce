...
@section('body')
    ...
    <section class="product_all mt-4">
        <div class="container-fluid">
            <p class="" style="font-size: 16px; font-weight: 700; line-height: 19px; color:#000000; margin-left: 26%; margin-bottom: 30px;">ALL PRODUCTS BY BRAND</p>
            <div class="row">
                                ...
                                <div class="col-xl-3 my-2 col-lg-3 col-md-3 col-sm-6 colsm6">
                                    <div class="card">
                                        <div class="card-header border-0 p-0 m-0 text-center">
                                            <a href="{{route('product.details',['id'=>$product->id])}}" target="blank">
                                                <img src="{{asset($product->image)}}" height="350" class="p-0 w-100" alt="a" />
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <a class="" href="{{route('product.details',['id'=>$product->id])}}">{{$product->name}}</a>
                                            <p class="">Brand: {{$product->brand->name}}</p>
                                            <div class="ratings d-flex justify-content-end hidden-sm">
                                                <abbr title="Add to cart"><a href="#" class="navbar-brand mx-2"><i class="price-text-color fa fa-2x fa-shopping-cart"></i></a></abbr>
                        ...
                        <div class="product-pagination mt-5 bg-white">
                            <nav>
                                <ul class="pagination">
                                    ...
                                    <li class="page-item">
                                        <a class="page-link text-dark" target="blank" href="index.html">2</a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link text-dark" target="blank" href="index.html">3</a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link text-dark" target="blank" href="index.html">4</a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link text-dark" target="blank" href="index.html">5</a>
                                    </li>
                                    <li class="page-item pagcom">
                                        <a class="page-link text-dark" target="blank" href="index.html">6</a>
                                    </li>
                                    <li class="page-item pagcom">
                                        <a class="page-link text-dark" target="blank" href="index.html">7</a>
                                    </li>
                                    <li class="page-item pagcom">
                                        <a class="page-link text-dark" target="blank" href="index.html">8</a>
                                    </li>
                                    <li class="page-item pagcom">
                                        <a class="page-link text-dark" target="blank" href="index.html">9</a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link text-dark" href="index.html" rel="next" aria-label="Next »">›</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
