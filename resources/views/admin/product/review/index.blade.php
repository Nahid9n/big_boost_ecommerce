...
@section('title','Product Reviews page')
@section('body')
    <!-- PAGE-HEADER -->
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Product Review Module</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
        ...
        <div class="col">
            <div class="card">
                <div class="border-bottom m-3">
                    <div class="row">
                        <div class="">
                            <h3 class="card-title">All Product Review Table</h3>
                        </div>
                        <div class="text-end">
...
{{--                                    <td>{{$loop->iteration}}</td>--}}
                                    ...
                                    <td>{{$product->type->name ?? 'No Type'}}</td>
