                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" value="sku code" name="sku" id="myInput2"/>
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4 d-flex form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control select2 select2-show-search form-select" name="type_id" data-placeholder="Choose one">
                                    <option class="form-control" label="Choose one" selected>No Type</option>
                        ...
                        <div class="row mb-4">
                            <label for="imgInp" class="col-md-3 form-label">Product thumbnail Image (500x500)</label>
                            <div class="col-md-9">
