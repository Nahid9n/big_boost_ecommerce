                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('units.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="name" required value="{{old('name')}}" name="name" placeholder="Enter your Unit name" type="text">
                        ...
                        <button class="btn btn-primary px-4" type="submit">Create Unit</button>
                    </form>
                </div>
            </div>
        </div>
