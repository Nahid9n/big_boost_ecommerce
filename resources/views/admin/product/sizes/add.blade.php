                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('sizes.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="name" required value="{{old('name')}}" name="name" placeholder="Enter your Size name" type="text">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{old('code')}}" id="code" name="code" placeholder="Enter Size Short Code" type="text">
                            </div>
                        </div>
                        ...
                        <button class="btn btn-primary px-4" type="submit">Create Size</button>
                    </form>
                </div>
            </div>
        </div>
