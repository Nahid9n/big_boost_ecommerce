    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">size Module</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
            ...
            <div class="card">
                <div class="border-bottom m-3">
                    <div class="row">
                        ...
                        <div class="text-end">
                            <a href="{{route('sizes.create')}}" class="btn btn-success my-1 float-end text-center">Create New size</a>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom  w-100">
                            ...
                            @foreach($sizes as $size)
                                ...
                                <td class="text-center">
                                    <a href="{{route('sizes.edit',$size->id)}}" class="btn btn-success my-2"><i class="fa fa-edit"></i></a>
