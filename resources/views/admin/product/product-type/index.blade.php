            ...
            <div class="card">
                <div class="border-bottom m-3">
                    <div class="row">
                        ...
                        <div class="text-end">
                            <a href="{{route('product-type.create')}}" class="btn btn-success my-1 float-end text-center">Create New Product Type</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-responsive export-table">
                        <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom  w-100">
                            ...
                            @foreach($productTypes as $productType)
                                ...
                                <td><img src="{{asset($productType->image)}}" class="img-fluid" width="120" height="80" alt=""></td>
                                <td>{{$productType->name}}</td>
                                <td>{{$productType->status == 1 ? 'active':'Inactive'}}</td>
                                <td class="text-center">
                                    <a href="{{route('product-type.edit',$productType->id)}}" class="btn btn-success my-2"><i class="fa fa-edit"></i></a>
