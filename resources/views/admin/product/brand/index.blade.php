            ...
            <div class="card">
                <div class="border-bottom m-3">
                    <div class="row">
                        ...
                        <div class="text-end">
                            <a href="{{route('brands.create')}}" class="btn btn-success my-1 float-end text-center">Create New Brand</a>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom  w-100">
                            ...
                            @foreach($brands as $brand)
                                ...
                                <td class="justify-content-center d-flex">
                                    <a href="{{route('brands.edit',$brand->id)}}" class="btn btn-success my-2 me-2"><i class="fa fa-edit"></i></a>
