...
@section('body')
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">{{$type->name}} Module</h1>
        </div>
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);">{{$type->name}}</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{$type->name}} Module</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
        ...
        <div class="col">
            <div class="card">
                <div class="border-bottom m-3">
                    <div class="row">
                        <div class="">
                            <h3 class="card-title">All {{$type->name}} Table</h3>
                        </div>
                        <div class="text-end">
