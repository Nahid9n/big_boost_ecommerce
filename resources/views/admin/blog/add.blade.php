                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('blogs.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="title" required value="{{old('title')}}" name="title" placeholder="Enter your Blog Post Title" type="text">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{old('slug')}}" id="slug" name="slug" placeholder="Enter your slug here" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            <label  class="col-md-3 form-label">Blog Other Images</label>
                            <div class="col-md-9">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{old('meta_title')}}" id="meta_title" name="meta_title" placeholder="Enter Meta Title" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" id="meta_description" name="meta_description" placeholder="Enter Meta Description" type="text">{{old('metaDescription')}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="meta_keyword" class="col-md-3 form-label">Meta Keyword</label>
                            <div class="col-md-9">
                                <input class="form-control" value="{{old('meta')}}" id="meta_keyword" name="meta_keyword" placeholder="Enter keywords" type="text">
                            </div>
                        </div>
                        <div class="row mb-4 d-flex form-group">
                            <div class="col-md-3">
