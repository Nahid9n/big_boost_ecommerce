        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="">Add Product</a></li>
                        @if (checkUserPermission('product.create'))
                        <li><a href="{{route('product.create')}}" class="slide-item">Add Product</a></li>
                        @endif
                        <li><a href="{{route('product.index')}}" class="slide-item">All Product</a></li>
                        @foreach($productTypes as $productType)
                        <li><a href="{{route('product-by-type',['id'=>$productType->id])}}" class="slide-item">{{$productType->name}}</a></li>
                        @endforeach
                        <li><a href="#" class="slide-item">Seller Product</a></li>
                        ...
                        <li><a href="{{route('sizes.index')}}" class="slide-item">Sizes</a></li>
                        <li><a href="{{route('product-type.index')}}" class="slide-item">product Type</a></li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Auction Products</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Auction Products</a></li>
                        <li><a href="{{ route('auction.product.index') }}" class="slide-item">All Product</a></li>
                        <li><a href="{{ route('auction.product.create') }}" class="slide-item">Add Product</a></li>
                       {{--  @foreach($productTypes as $productType)
                        <li><a href="{{route('inHouse.auction.product',['id'=>$productType->id])}}" class="slide-item">{{$productType->name}}</a></li>
                        @endforeach --}}
                        <li><a href="{{ route('auction.product.type.index') }}" class="slide-item">All Product Type</a></li>
                        <li><a href="{{ route('auction.product.type.create') }}"class="slide-item">Add Product Type </a></li>
                        @foreach ($auctionProductTypes as $auctionProductType)
                        <li><a href="{{ route('whole-sale-product-type',['id'=>$auctionProductType->id]) }}" class="slide-item">{{ $auctionProductType->type_name }}</a></li>
                        @endforeach
                        <li><a href="" class="slide-item">Auction product Orders</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{route('whole-sale-product-type.index')}}" class="slide-item">All Product Type</a></li>
                        <li><a href="{{route('whole-sale-product-type.create')}}" class="slide-item">Add Product Type</a></li>
                        @foreach ($wholesaleProductTypes as $wholesaleProductType)
                        <li><a href="{{ route('whole-sale-product-type',['id'=>$wholesaleProductType->id]) }}" class="slide-item">{{ $wholesaleProductType->name }}</a></li>
                        @endforeach

                        <li><a href="table-editable.html" class="slide-item">Wholesale product Orders</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{route('deliveryBoy.paymentHistory')}}" class="slide-item">Payment history</a></li>
                        ...
                        <li><a href="#" class="slide-item">configuration</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Courier Module</a></li>
                        <li><a href="{{route('couriers.index')}}" class="slide-item">All Courier</a></li>
                        <li><a href="{{route('couriers.create')}}" class="slide-item">Add Courier</a></li>
                    </ul>
                </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="tables.html" class="slide-item">Request refund</a></li>
                        <li><a href="table-editable.html" class="slide-item">Approve refund</a></li>
                        <li><a href="table-editable.html" class="slide-item">Rejected refund</a></li>
                        <li><a href="table-editable.html" class="slide-item">Configuration</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="table-editable.html" class="slide-item">packages</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('seller.index') }}" class="slide-item">All Seller</a></li>
                        <li><a href="{{ route('seller.create') }}" class="slide-item">Add Seller</a></li>
                        <li><a href="{{ route('product-seller.index') }}" class="slide-item">All Product</a></li>
                        <li><a href="{{ route('product-seller.create') }}" class="slide-item">Add Product</a></li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="table-editable.html" class="slide-item">Subscribers</a></li>
                        <li><a href="table-editable.html" class="slide-item">Coupon</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="tables.html" class="slide-item">Product conversion</a></li>
                        <li><a href="table-editable.html" class="slide-item">Product Queries</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                ...
                <li class="slide mb-5">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{route('website-settings.index')}}" class="slide-item">Manage Website Details</a></li>
