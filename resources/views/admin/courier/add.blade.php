        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="card-title">Create New Courier</h3>
                </div>
                <div class="text-end">
                    <a href="{{route('couriers.index')}}" class="btn btn-success my-1 float-end mx-2 text-center">All Courier</a>
                </div>
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('couriers.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="name" required value="{{old('name')}}" name="name" placeholder="Enter your Courier name" type="text">
                        ...
                        <button class="btn btn-primary px-4" type="submit">Create Courier</button>
                    </form>
                </div>
            </div>
        </div>
