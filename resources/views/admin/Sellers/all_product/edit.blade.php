                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('product-seller.update',$product_seller->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4 ">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <select name="seller_id" class="form-control select2-show-search form-select"
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="short_description" id="short_description" placeholder="Short Description" value="{{ $product_seller->short_description  }}" ></textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="summernote" class="col-md-3 form-label">Long Description</label>
                            <div class="col-md-9">
                                <textarea class="form-control" name="long_description" id="summernote" placeholder="Long Description" value="{{$product_seller->long_description }}"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4 d-flex form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control select2 form-select" name="refund" data-placeholder="Choose one">
                                    ...
                                    <option value="1" {{ $product_seller->status == 1 ? " Refundable" : " " }} >Refundable</option>
                                    <option value="0"  {{ $product_seller->status == 0 ? " Non-Refundable" : " " }}>Non-Refundable</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-4 d-flex form-group">
