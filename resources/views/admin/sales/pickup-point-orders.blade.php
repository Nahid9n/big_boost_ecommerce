...
@section('body')
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Pickup Point Order Module</h1>
        </div>
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);">Pickup Point Order</a></li>
                <li class="breadcrumb-item active" aria-current="page">Manage Pickup Point Order Module</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="border-bottom m-3">
                    <div class="row">
                        <div class="">
                            <h3 class="card-title">Pickup Point Orders Table</h3>
                        </div>
                        <div class="text-end">
