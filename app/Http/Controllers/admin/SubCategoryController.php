...
class SubCategoryController extends Controller
{
    ...
    {
        return view('admin.product.sub-category.index',
    ...
    {
        return view('admin.product.sub-category.edit', ['categories' => Category::all(), 'sub_category' => $subCategory]);
    }
    ...
    public function update(Request $request, SubCategory $subCategory)
    {
        ...
        return redirect('admin/sub-category')->with('message', 'sub category info update successfully.');
    }
